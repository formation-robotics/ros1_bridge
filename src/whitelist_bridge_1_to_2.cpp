...
int main(int argc, char * argv[]) {
  // ROS 1 node
  ros::init(argc, argv, "whitelist_bridge_1_to_2");
  ros::NodeHandle ros1_node;

  // ROS 2 node
  rclcpp::init(argc, argv);
  auto ros2_node = rclcpp::Node::make_shared("whitelist_bridge_1_to_2");
  ...
  if (argc % 4 != 1) {
   ...
   ros1_bridge::Bridge1to2Handles handles[num_bridges];
   ...
   for (int i = 1; i < argc; i += 4) {
       ...
       handles[bridge_i] = ros1_bridge::create_bridge_from_1_to_2(
         ros1_node, ros2_node,
